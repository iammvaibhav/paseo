...
import { buildAskPillPresentation, resolveAskTitle } from "./track-presentation";
...
export function SelectionAsksList({
  ...
  const pill = buildAskPillPresentation(t, asks);
  ...
  return (
    ...
    >
      <ComposerTrackActions divided={asks.length > 0}>
