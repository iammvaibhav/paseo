...
import type {
  ...
  WorkItemMoveRequest,
  WorkItemMoveResponse,
  WorkItemDispatchResponse,
  WorkCommentListRequest,
  WorkCommentListResponse,
  WorkCommentCreateRequest,
  WorkCommentCreateResponse,
  WorkActivityListRequest,
  WorkActivityListResponse,
  WorkLabelListRequest,
  WorkLabelListResponse,
  WorkLabelUpsertRequest,
  WorkLabelUpsertResponse,
  WorkLabelDeleteResponse,
  WorkPageListRequest,
  WorkPageListResponse,
  WorkPageGetResponse,
  WorkPageUpsertRequest,
  WorkPageUpsertResponse,
  WorkPageDeleteResponse,
  WorkDraftListRequest,
  WorkDraftListResponse,
  WorkDraftCreateRequest,
  WorkDraftCreateResponse,
  WorkDraftPromoteResponse,
  WorkStickyListRequest,
  WorkStickyListResponse,
  WorkStickyUpsertRequest,
  WorkStickyUpsertResponse,
  WorkStickyDeleteResponse,
  WorkViewListRequest,
  WorkViewListResponse,
  WorkViewUpsertRequest,
  WorkViewUpsertResponse,
...
export class DaemonClient {
  ...
  async workItemGet(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkItemGetResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.item.get.response">({
      requestId: input.requestId,
      message: { type: "work.item.get.request", id: input.id },
    });
  }

  async workItemCreate(
    input: Omit<WorkItemCreateRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkItemCreateResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.item.create.response">({
      requestId,
      message: { type: "work.item.create.request", ...fields },
    });
  }

  async workItemUpdate(
    input: Omit<WorkItemUpdateRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkItemUpdateResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.item.update.response">({
      requestId,
      message: { type: "work.item.update.request", ...fields },
    });
  }

  async workItemDelete(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkItemDeleteResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.item.delete.response">({
      requestId: input.requestId,
      message: { type: "work.item.delete.request", id: input.id },
    });
  }

  async workItemMove(
    input: Omit<WorkItemMoveRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkItemMoveResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.item.move.response">({
      requestId,
      message: { type: "work.item.move.request", ...fields },
    });
  }

  async workItemDispatch(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkItemDispatchResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.item.dispatch.response">({
      requestId: input.requestId,
      message: { type: "work.item.dispatch.request", id: input.id },
    });
  }

  async workCommentList(
    input: Omit<WorkCommentListRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkCommentListResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.comment.list.response">({
      requestId,
      message: { type: "work.comment.list.request", ...fields },
    });
  }

  async workCommentCreate(
    input: Omit<WorkCommentCreateRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkCommentCreateResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.comment.create.response">({
      requestId,
      message: { type: "work.comment.create.request", ...fields },
    });
  }

  async workActivityList(
    input: Omit<WorkActivityListRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkActivityListResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.activity.list.response">({
      requestId,
      message: { type: "work.activity.list.request", ...fields },
    });
  }

  async workLabelList(
    input: Omit<WorkLabelListRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkLabelListResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.label.list.response">({
      requestId,
      message: { type: "work.label.list.request", ...fields },
    });
  }

  async workLabelUpsert(
    input: Omit<WorkLabelUpsertRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkLabelUpsertResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.label.upsert.response">({
      requestId,
      message: { type: "work.label.upsert.request", ...fields },
    });
  }

  async workLabelDelete(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkLabelDeleteResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.label.delete.response">({
      requestId: input.requestId,
      message: { type: "work.label.delete.request", id: input.id },
    });
  }

  async workPageList(
    input: Omit<WorkPageListRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkPageListResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.page.list.response">({
      requestId,
      message: { type: "work.page.list.request", ...fields },
    });
  }

  async workPageGet(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkPageGetResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.page.get.response">({
      requestId: input.requestId,
      message: { type: "work.page.get.request", id: input.id },
    });
  }

  async workPageUpsert(
    input: Omit<WorkPageUpsertRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkPageUpsertResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.page.upsert.response">({
      requestId,
      message: { type: "work.page.upsert.request", ...fields },
    });
  }

  async workPageDelete(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkPageDeleteResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.page.delete.response">({
      requestId: input.requestId,
      message: { type: "work.page.delete.request", id: input.id },
    });
  }

  async workDraftList(
    input: Omit<WorkDraftListRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkDraftListResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.draft.list.response">({
      requestId,
      message: { type: "work.draft.list.request", ...fields },
    });
  }

  async workDraftCreate(
    input: Omit<WorkDraftCreateRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkDraftCreateResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.draft.create.response">({
      requestId,
      message: { type: "work.draft.create.request", ...fields },
    });
  }

  async workDraftPromote(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkDraftPromoteResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.draft.promote.response">({
      requestId: input.requestId,
      message: { type: "work.draft.promote.request", id: input.id },
    });
  }

  async workStickyList(
    input: Omit<WorkStickyListRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkStickyListResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.sticky.list.response">({
      requestId,
      message: { type: "work.sticky.list.request", ...fields },
    });
  }

  async workStickyUpsert(
    input: Omit<WorkStickyUpsertRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkStickyUpsertResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.sticky.upsert.response">({
      requestId,
      message: { type: "work.sticky.upsert.request", ...fields },
    });
  }

  async workStickyDelete(input: {
    id: string;
    requestId?: string;
  }): Promise<WorkStickyDeleteResponse["payload"]> {
    return this.sendNamespacedCorrelatedSessionRequest<"work.sticky.delete.response">({
      requestId: input.requestId,
      message: { type: "work.sticky.delete.request", id: input.id },
    });
  }

  async workViewList(
    input: Omit<WorkViewListRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkViewListResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.view.list.response">({
      requestId,
      message: { type: "work.view.list.request", ...fields },
    });
  }

  async workViewUpsert(
    input: Omit<WorkViewUpsertRequest, "type" | "requestId"> & { requestId?: string },
  ): Promise<WorkViewUpsertResponse["payload"]> {
    const { requestId, ...fields } = input;
    return this.sendNamespacedCorrelatedSessionRequest<"work.view.upsert.response">({
      requestId,
      message: { type: "work.view.upsert.request", ...fields },
    });
  }
