...
| [docs/work.md](docs/work.md)                                               | Work: Kanban for agents — work items, lanes vs derived columns, single bucket authority, auto-pickup, fleet scoping                              |
...
- **Work** — native Kanban for agents: work items with human keys, lanes vs derived columns over the shared lifecycle bucket, auto-pickup through the Mission Control approval gate — see [docs/work.md](docs/work.md)
