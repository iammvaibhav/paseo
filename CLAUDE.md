...
| [docs/mission-control.md](docs/mission-control.md)                 | Mission Control: fleet board, milestone feed (gateway summarizer), Commander agent, digest queue, daemon peering               |
...
- **Mission Control** — fleet monitoring and dispatch: deterministic cross-host board, LLM-gateway-summarized milestone feed, Commander agent with idle-flush digest queue, daemon peering with sleep-aware errors — see [docs/mission-control.md](docs/mission-control.md)
